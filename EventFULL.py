...
    print("")
    print("EVENTFUL is one of singapores leading event management websites")
...
electronic music festival that debuted in 2015 in Singapore as part of Ultra Music Festivals
...
price":"$40","Description":"Take part in the final edition of Safari Zoo Run before Mandais
...
technological university","Ticket price":"$45","Description":"Surf N Sweat is Singapores
...
    my_artfunction()
If a=="artcompetitions" or a=="Artcompetition":
    my_artsfunction()
