...
##code is sourced from https://www.tutorialspoint.com/How-can-I-source-a-Python-file-from-another-Python-file    
    ...
    def check_diagonals(board):
        return (board[0][0] == board[1][1] and board[1][1] == board[2][2] and board[0][0] != " ") or                (board[2][0] == board[1][1] and board[1][1] == board[0][2] and board[2][0] != " ")
...
#https://www.foteinisavvidou.codes/how-to-build-a-tic-tac-toe-game-in-python/
