...
Projects in this repository:
  ...
  3. **Cybersecurity-portfolio** : Contains cybersecurity projects from the Google Cybersecurity Professional Certification, including security audits, risk assessments, managing file permissions in Linux, and SQL filtering for security investigations, all based on real-world scenarios - 2024
